...
const PAGE_DESCRIPTION = "What are the rules of the Randomizer Phasmophobia? We explain everything about how to play Phasmophobia Randomizer.";
?>
<!DOCTYPE html>
...
<body>
  ...
  <main>
    <section class="table_game rules">
